...
//	}
//	
//	public <E extends Serializable>List<E> pageList(PagesSearchStatement stat){
...
//		Map map= new HashMap();
//		QueryTranslator trans=this.queryTranslatorFactory.createFilterTranslator(hql, hql, map, (SessionFactoryImplementor) this.getSession().getSessionFactory());
